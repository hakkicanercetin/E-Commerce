...
const AddressRadio = ({ address,onSelect }: {
  ...
  return (  
    <>
      <div className="py-4">
        <label className="border-2 border-[#2126AB] rounded-lg p-4 flex items-center justify-between cursor-pointer transition-all duration-200 hover:shadow-md" onClick={onSelect}>
          <div className="flex">
            ...
            {address ? (
              <div>
                ...
                <p className="text-sm text-gray-500 py-4">{address.address}</p>
              </div>
            ):(
              <div>
                <p className="text-lg font-semibold">
